...
const ChatModal = ({ condition, set, defaultDialogId = null, videoCallData = null }) => {
      ...
      <>
         {cookies.loggedIn ? (
            <Modal
               ...
               condition={condition}
               set={set}>
               <Chat onCloseModal={() => set(false)} defaultDialogId={defaultDialogId} videoCallData={videoCallData} />
            </Modal>
         ) : (
