...
const PurchaseCreate = ({ isEdit = false }) => {
   ...
   const onSubmitHandler = data => {
      ...
      const resData = {
         ...
         ...(data.calc_props.find(i => i.id === 2 || i.id === 3) ? { price_type: 'month_payment', price: data.month_payment } : {}),
      ...
      sendPostRequest(
         ...
         window.location.href = `${BuyerRoutesPath.purchase.inner}${res.data.id}`;
      });
   };
