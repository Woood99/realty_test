                        ...
                        <div key={index} className={styles.ComparisonOption}>
                           ...
                           <div className="flex">
                              {data.map((object, index) => {
                                 ...
                                 if (item.value === 'livingArea') {
                                    currentField = object.minPrice / object.minPricePerMeter;
                                 }
                                 if (item.value === 'pricePerMeter') {
                                    currentField = object.price / object.area;
                                 }
                                 if (item.value === 'type') {
                                 ...
                                 if (item.value === 'min_price_complex') {
                                    const minPrice = findObjectWithMinValue(object.apartments, 'price')?.price.toString() || 0;
                                    currentField = minPrice;
                                 }
                                 if (item.value === 'cashback') {
                                    currentField = ((object.max_price || object.price) / 100) * object.cashback;
                                 }
