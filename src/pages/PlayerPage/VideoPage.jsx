...
import { ShortsModal, VideoPlayer } from '../../ModalsMain/VideoModal';
import PlayerCardsDynamic from '../../ModalsMain/VideoModal/components/PlayerCardsDynamic';
                        ...
                        <div>
                           {data ? (
                              <VideoPlayer
                                 ...
                                 childrenVideo={
                                    <>
                                       {Boolean(data.cards?.length) && <PlayerCardsDynamic data={data} variant="page" maxLength={15} />}
                                       <QuestionToChat
